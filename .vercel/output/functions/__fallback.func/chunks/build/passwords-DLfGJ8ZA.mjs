...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 lg:p-8 max-w-6xl mx-auto space-y-6" }, _attrs))}><div class="flex items-center justify-between"><div><h1 class="text-2xl font-bold text-white">Mots de passe</h1><p class="text-surface-400 text-sm mt-1">Vos identifiants prot\xE9g\xE9s</p></div><button class="btn-primary flex items-center gap-2">`);
      ...
      if (unref(loading)) {
        ...
        _push(`<p class="text-surface-400">Aucun mot de passe sauvegard\xE9.</p></div>`);
      } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dashboard/passwords.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=passwords-DLfGJ8ZA.mjs.map
