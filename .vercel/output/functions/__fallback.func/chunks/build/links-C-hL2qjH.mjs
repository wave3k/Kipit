...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function handleDelete(id) {
      if (confirm("Supprimer ce lien ?")) await deleteItem(id);
    }
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 lg:p-8 max-w-6xl mx-auto space-y-6" }, _attrs))}><div class="flex items-center justify-between"><div><h1 class="text-2xl font-bold text-white">Liens</h1><p class="text-surface-400 text-sm mt-1">Vos liens importants sauvegard\xE9s</p></div><button class="btn-primary flex items-center gap-2">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:plus",
        class: "w-4 h-4"
      }, null, _parent));
      _push(` Ajouter un lien </button></div>`);
      if (unref(loading)) {
        ...
        _push(`<p class="text-surface-400">Aucun lien sauvegard\xE9.</p></div>`);
      } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dashboard/links.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=links-C-hL2qjH.mjs.map
