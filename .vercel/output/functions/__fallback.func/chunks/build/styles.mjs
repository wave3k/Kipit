...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.D3HoQ0i4.mjs').then(interopDefault),
  ...
  "layouts/dashboard.vue": () => import('./dashboard-styles.DManeUvG.mjs').then(interopDefault)
};
