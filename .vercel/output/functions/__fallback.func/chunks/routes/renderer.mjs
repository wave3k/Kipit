...
import { a as buildAssetsURL, z as publicAssetsURL, H as useRuntimeConfig, p as getResponseStatusText, o as getResponseStatus, j as encodePath, g as defineRenderHandler, m as getQuery, c as createError, q as getRouteRules, u as joinURL, G as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Kipit - Stockez vos mots de passe, liens et clés crypto en toute sécurité avec un chiffrement zero-knowledge."}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"Kipit - Votre coffre-fort numérique"};
