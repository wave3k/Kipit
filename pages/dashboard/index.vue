<template>
  <div class="p-6 lg:p-8 max-w-6xl mx-auto space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="card">
        <div class="flex items-center justify-between mb-3">
          ...
          <span v-else class="text-xs text-surface-500">Illimité</span>
        </div>
    ...
    <div v-if="!isPremium" class="card border-accent-600/30 bg-gradient-to-r from-accent-900/20 to-surface-900">
      <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p class="text-sm text-surface-400 mt-1">
            Stockage illimité pour seulement 2,99 €/mois. Payez avec Mobile Money.
          </p>
        </div>
...
const { user, isPremium } = useAuthClient()
